...
export default {
  ...
  content: <div>
    ...
    Whenever a Quirk would reasonably give you more experience or aptitude in a situation, apply a Favored +1 to your rolls. If a Quirk would reasonably increase the difficulty of a situation apply an Unfavored -1 to your rolls, but you're awarded 3 <Link to="rules/leveling">XP</Link> instead of 1 for any Hard Success that would award XP, and 1 XP for any other result. You cannot apply more than 1 Quirk to a single roll. You may also as a Reaction attempt to Influence a nearby ally if you have a Quirk that is relevant to a d20 roll they are attempting. Roll a d10, on a 6+ they may apply your Quirk to their d20 roll. On a 1 you get in their way and apply an Unfavored -1 to their roll instead.<br/>
		<hr/>
