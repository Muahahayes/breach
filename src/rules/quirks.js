...
export default {
  ...
  content: <div>
    ...
    Whenever a Quirk would reasonably give you more experience or aptitude in a situation, apply a Favored +1 to your rolls. If a Quirk would reasonably increase the difficulty of a situation apply an Unfavored -1 to your rolls, but you're awarded 3 <Link to="rules/leveling">XP</Link> instead of 1 for any Hard Success that would award XP, and 1 XP for any other result. You cannot apply more than 1 Quirk to a single roll.<br/>
		<hr/>
