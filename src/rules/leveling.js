...
export default {
  ...
  content: <div>
    ...
    <br/>
    Every 5 XP points you may choose 1 Skill that gave you one of these 5 XP points, increase that Skill by 1. Also you immediately must choose a Proficiency from a Gift or your Source, or choose a Lesser Gift from your Source. This choice must be within the given threshold as denoted by G, representing your level. Proficiencies increase the power/utility of a Gift, grant passive bonuses or grant sub-powers. Starting at 5G you increase a Skill and gain a Proficiency after acquiring 10 points, instead of 5. <br/></span>
    <hr/>
    <h3>Leveling Up:</h3>
    <span>When you gain enough XP for your next level you must select a new Gift from your Source after your next Full Sleep (or Reboot for Cybernetics). Also, the Proficiency you gain at this XP cannot be from this new Gift. Gain max <Link to="stats">Survival</Link> equal to your Stamina. Reset XP to 0 (This is Leveling Up). Your number of Gifts acts as a benchmark of your progression and some Powers cannot be selected until you reach certain thresholds as denoted by G (the number of Gifts you possess). Every even numbered G, increase one <Link to="stats">Attribute</Link> by 1.<br/>
