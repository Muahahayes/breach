...
export default {
  ...
  content: <div>
    ...
    <hr/>
    <h3>Leveling Up:</h3>
    <span>When you gain enough XP for your next level your level is increased by 1, then you must first spend your Proficiency gained from this XP. Select a new Power and a new Lesser Power equal to your LVL or lower from your Source after your next Full Sleep. Gain Max <Link to="stats">Survival</Link> equal to double your Stamina. Reset XP to 0 and add any leftover XP past the leveling threshold (if any). Every even numbered level, increase any one <Link to="stats">Attribute</Link> by 1.<br/>
    If you are creating a character higher than LVL 1: for each level you skipped, select proficiencies at each level equal to the number listed on the XP chart below obeying the [LVL] limits of that level. (eg. A LVL 3 character would select 3 [LVL 1] proficiencies and 8 [LVL 1] or [LVL 2] proficiencies). Then, add those proficiencies together to use as Skill points and increase any of your Skills by distributing these points (remember, a Skill can only be as high as 3 times your level). (eg. A LVL 3 character would distribute 8 Skill points to any Skills they like). Remember, Techniques are learned through story progression and cannot be arbitrarily chosen at character creation, even for characters created above LVL 1!<br/>
