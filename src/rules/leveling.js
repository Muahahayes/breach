...
export default {
  ...
  content: <div>
    ...
    <hr/>
    <h3>Leveling Up:</h3>
    <span>When you gain enough XP for your next level you must select a new Power and a new Lesser Power from your Source after your next Full Sleep. However, the Proficiency you gain from this XP cannot be used on this new Power. Gain max <Link to="stats">Survival</Link> equal to double your Stamina. Reset XP to 0 plus any leftover XP past the leveling threshold. Some Powers cannot be selected until you reach certain thresholds as denoted by Level. Every even numbered level, increase one <Link to="stats">Attribute</Link> by 1.<br/>
