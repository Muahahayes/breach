...
content: <div>
  ...
  <p>If a Skill, Technique, Gift, or other thing you do tells you to use a type of Action see the rules for each listed below. If it tells you that you may do it as a "free action" or "at will" it does not need an Action and may be done without spending one.<br/><br/>
	<b>Full:</b><br/> You have 2 Full Actions per turn. Sometimes just called Action, with a Full Action you can Attack, use some Powers, Grapple, or interact with objects on your turn. All characters may use their Action on their turn to begin Blocking. You may not use a Full Action to do the same Action you have done previously in the turn. As a rule of thumb, anything that takes more than 1 second of effort will take a Full Action, and anything that takes more than 5 seconds will take an additional Full Action each turn for each 5 seconds of effort.<br/><br/>
	<b>React:</b><br/> You can use some Powers or a readied Full/Movement Action on another creature's turn. To ready a Action on your turn to use as a React Action you must declare the Action, declare what Action another creature does or other type of event that will trigger your Action. This uses your Action on your current turn, and uses your React when it is triggered. Movement done in this way is limited to half your available movement distance.<br/><br/>
  ...
  <b>Activate:</b><br/> Some proficiencies, passive effects, techniques, or items may require an Activation Action. This is separate from your Full Action, may only be used once per Round, and cannot be readied on its own as a Reaction. However, if a readied Full or Movement Action requires an Activation Action as a base cost of doing the Action or a Gift specifies a trigger for the Activation Action it may be used if you still have it available.</p>
  <hr/>
  <h3>Attacking:</h3>
