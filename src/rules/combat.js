...
content: <div>
  ...
  <b>Activate:</b><br/> Some proficiencies, passive effects, techniques, or items may require an Activation Action. This is separate from your Minor Action, may only be used once per Round, and cannot be readied on its own as a Reaction. However, if a readied Minor or Movement Action requires an Activation Action as a base cost of doing the Action or a Gift specifies a trigger for the Activation Action it may be used if you still have it available.</p>
  <hr/>
  <h3>Attacking:</h3>
  ...
  <hr/>
  <h3>Blocking:</h3>
  <p>You may spend a Minor Action to begin Blocking, you may attempt Block checks as a Free Action against any attack which hits you until your next Turn. Block checks are done by rolling [Block + Strength] vs the result of the attack roll which hit you. You may only Block if you are holding a melee weapon or <Link to="/equipment/aegis">Aegis</Link>. On any Success, you reduce the damage amount of the attack by the difference between the rolls plus an additional amount based on your Aegis. On a Hard Fail, you are no longer Blocking.</p>
  <hr/>
  <h3>Prone:</h3>
