...
content: <div>
  ...
  <b>Rounds:</b><br/> A collection of Turns and Phases, each creature takes 1 Turn in order per Phase and the Round concludes after each creature has finished their Turns. At the start of a new round every creature rolls their Speed dice to determine the maximum distance of their Movement Action and order in the next Round. Then, all creatures go in order and decide if they wish to use their Movement Action or not and where they would like to move.<br/><br/>
