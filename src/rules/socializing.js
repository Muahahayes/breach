...
export default {
  ...
  content: <div>
    ...
    <span>To persuade a person who disagrees with your stance/idea you must initiate an Argument. 
      ...
      The GM determines how stubbornly the person is holding their ground on their stance (if unsure, roll 1d4 or 2d4, if the player is making an outrageous argument you may want to roll 3d4), this is the Agreement threshold. When you gain points equal to their threshold you win the Argument.<br/>
      Consult with your fellow players and GM if they want to allow Arguments to have a meaningful effect between player characters.<br/></span>
      <br/>
    ...
    <span>Roll d20 + Persuasion vs their d20 + Insight (or Persuasion if they are attempting a Counter-Argument of their own to convince you to agree with their stance).<br/> 
      For a <b>Hard Success</b> you gain an Agreement point towards their threshold (this does not give XP, if you win the Argument and made at least 1 Hard Success then the Argument as a whole counts as a single Hard Success for a G number of XP).<br/> 
      For a <b>Soft Success</b> you must make an acceptable compromise or forfeit the point and roll again.<br/> 
      For a <b>Soft Fail</b> you do not gain the point, after you have failed a number of times greater than your G you have lost the Argument.<br/> 
      For a <b>Hard Fail</b> you lose the Argument (and gain XP for the Hard Fail). (At 3G+ this applies on your second Hard Fail)<br/> 
