...
export default {
  ...
  content: <div>
    ...
    <ul>
      ...
      <li><b>Assign your <Link to="/rules/skills">Skill</Link> Points:</b> Using the Creation Skill Points from your Race, you may increase your Skills. A Skill may never be more than 5 times your level. Any Skills you did not assign points to will start at -2. If a Skill is listed in your Race's Favored Skills, it begins at 0 instead.</li>
      ...
      <li><b>Select your first <Link to="/powers">Power</Link> and Lesser Power:</b> You may only select Powers and Lesser Powers from your Source, and they must be [LVL 1]. As you level up you will select a new Power and Lesser Power at each level, which must be a [LVL] equal or less than your level.</li>
      <li><b>Assign your first <Link to="/leveling">Proficiencies</Link>:</b> At character creation you are awarded 3 Proficiencies, which may be spent on your first Power or on your passive Source Proficiencies. These may not be used to gain Lesser Powers.</li>
    ...
    <span>Bob wants to play Breach with his friends, but he needs a character first! Bob's always been a fan of sneaky lizard races in his RPG playing, so he names his character Argo and writes 5 Quirks that describe him as a thief who upset a crime syndicate and is now on the run.
      ...
      Now that Bob's character has an identity, race, and skills, he looks at the Sources to find one that best fits the playstyle he's going for. He likes the Dermal Markings Power because of its Hide boosting Proficiency called Camouflage, along with some other melee focused abilities in the Mutation Source, so he selects Mutation. 
      He looks through Mutation's [LVL 1] Powers and settles on Retractable Claws as his first choice, it helps him in combat right away and he can pick up Dermal Markings at level 2 when he wants more utility.
