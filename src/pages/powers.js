...
export default {
  ...
  content: <div>
    <p>
    Powers are a supernatural or technological ability or gift given by your <a href="sources">Source</a>. When you <a href="rules/leveling">Level Up</a> you gain a new Power, this new Power must have a [LVL] requirement at or below your current level. Also when you Level Up you gain a new Lesser Power.
    <br/>
    ...
    Level, put in a number to filter the Powers by level and only see Powers of the level you choose. <br/>
    ...
    <li><a href="/sources/mutation/powers">Mutation</a></li>
    </ul>
  </div>
}