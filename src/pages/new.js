...
export default {
  ...
  content: <div>
    ...
    <br/>
    <b>HP:</b> Split in two! (See <Link to="stats">Stats</Link>)<br/>
    ...
    <br/>
    <b>Attributes:</b> Trimmed down! (See <Link to="stats">Stats</Link>)<br/>
    ...
    <br/>
    <b>XP:</b> Now with less murder-hobo! (See <Link to="leveling">XP</Link>)<br/>
    ...
    <br/>
    <b>Succeed/Fail:</b> Hard what? (See <Link to="skills">Skills</Link>)<br/>
