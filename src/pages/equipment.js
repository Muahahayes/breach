...
export default {
  ...
  content: <div>
    ...
    The effect given by that item will be listed on that item's Equipment page. Items will have a Price listed on their page, this Price is the standard value in Virtua but may change based on region.
