...
export default {
  ...
  "content": <div>
    ...
    Each race has a description with this format</p>
    <ul>
    ...
    <li>Favored Attribute(s): when adding to the value of your Attributes at character creation, if you do not select an Attribute listed here it will cost 2 AP per point added. (TODO possibly remove and just have the starting values and remaining AP dictate what they prefer? have the total points equal across races)</li>
    <li>Creation AP: this is how many AP you can spend on increasing your Attributes before gaining any Gifts, this is affected by Favored Attributes and the AP gained from Gifts throughout your story is not.</li>
    ...
    <li>Bonuses/sub-powers: various unique perks given by your Race with various effects.</li>
    </ul>
  </div>
}