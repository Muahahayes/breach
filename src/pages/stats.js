...
export default {
  ...
  <div>
    ...
    <br/>
    <span><b>Avoidance:</b> Your character gains Avoidance from their equipment, Race, and some Powers. When a creature attempts to Attack your character, the difficulty of the Attack roll is increased by your Avoidance.</span><br/>
    <br/>
