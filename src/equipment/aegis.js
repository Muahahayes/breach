...
export default {
  name: 'Shields',
  description: <p>
    A shield is a plate of hard material used to block attacks and protect the user, providing passive Avoidance. When you Block add the shield's Reduction to the damage reduction of your Block.
  ...
  stats: ['price', 'avoidance', 'reduction', 'strength', 'tags'],
  equipment: [ 
    {
      name: 'Wooden Shield',
    ...
    {
      name: 'Iron Buckler',
      description: 'A smaller disk of metal which is designed for deflecting blows rather than blocking them. It has a low threshold for protection but allows to user to avoid hits more easily.',
      price: 10,
      avoidance: 2,
      reduction: 1,
      strength: 1,
