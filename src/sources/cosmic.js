export default {
  ...
  capstones: [
    "Archon: Once per Full Sleep you may, as an Action, enter into an Archon form. While within this form your body becomes translucent and thrums with energy matching your Elemental Soul. When rolling dice for damage or healing, after seeing the result of the roll you may spend 1 ae to replace that result with the maximum value of that die. This form lasts for 1 minute and ends prematurely if you are made unconscious, or asleep."
  ],
  lesser: [
    [
