  ...
  [ // LVL 1
    ...
    },
    {
      ...
      proficiencies: [
        ...
        [
          "Sturdy: During a Rampage with Numb active, you may use Protection once per Full Sleep without referring to or counting towards your limit (This effectively gives you a second usage if one usage is during a Numb Rampage)."
        ]
      ]
    },
    {
    ...
    },
    {
      ...
      proficiencies: [
        ...
        [
          ...
          "Greater Linger: Shadowmark may be used thrice before being removed. Requires Linger."
        ]
      ]
    },
    {
    ...
    },
    {
      ...
      proficiencies: [
        [
          "Pressure: You may add your level to your Bind Daemon Will Save difficulty.",
        ...
        [
          "Dark Gift: You may bestow each of your Daemons with a [Common] Power you possess, not including Minion Powers. They may not use any proficiencies with this Power.",
          ...
          "Greater Gift: You may bestow Powers up to [Epic]. Requires Dark Gift."
        ],
        [
          "Cult: You may have up to one hundred bindings active at one time. Requires Crowd.",
          "Patron: You may bestow the Bind Daemon Power. They may use the higher of the Pair, Trio, Company or Crowd proficiencies if you have one. Requires Greater Gift."
        ]
      ]
    },
    {
    ...
    },
    {
      ...
      proficiencies: [
        ...
        [
          ...
          "Greater Infusion: Infusion may be used to reinfuse a Greater Chaos Gem to create a Greater Soul Gem. To do so, you must use a Soul Fragment from a creature of at least level 6 and who had a Will of at least 7. Requires Moderate Infusion."
        ],
        [
          "Epic Infusion: Infusion may be used to reinfuse an Epic Chaos Gem to create an Epic Soul Gem. To do so, you must use a Soul Fragment from a creature of at least level 8 and who had a Will of at least 10. Requires Greater Infusion."
        ]
      ]
    },
    {
    ...
    // power idea: Inciting Shout
    // let out a rage filled roar filled with malice, make a Disruption check vs insight, nearby creatures focus on attacking you for X turns but they receive a Favored +1 on their attack rolls
    // profs: can spend bloodlust when a creature hits you to deal damage to both you and them? increase duration? increase range? as an activation action can remove the Favored +1?
  ],// LVL 2
  [// LVL 3
    {
